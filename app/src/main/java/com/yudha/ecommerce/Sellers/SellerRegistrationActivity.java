...
public class SellerRegistrationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sellerLoginRegister=findViewById(R.id.seller_already_have_account_btn);
        ...
        sellerLoginRegister.setOnClickListener(new View.OnClickListener() {
            @Override
