...
import com.yudha.ecommerce.Model.Cart;
import com.yudha.ecommerce.Prevalent.Prevalent;
import com.yudha.ecommerce.R;
import com.yudha.ecommerce.ViewHolder.CartViewHolder;
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                if (dataSnapshot.exists()){
                    ...
                    if (shipmentState.equals("shipped")){
                        ...
                        Toast.makeText(CartActivity.this, "You can purchase more product,once you received your first final.", Toast.LENGTH_SHORT).show();
                    }
